...
| `[docs/adr/ADR-0005-proxy-session-gate-two-authority-refresh.md](docs/adr/ADR-0005-proxy-session-gate-two-authority-refresh.md)`                                       | Opening line: `proxy.ts` → `src/proxy.ts` (convention entry); keep `src/supabase/proxy.ts` as implementation detail                                                                                                                           |
