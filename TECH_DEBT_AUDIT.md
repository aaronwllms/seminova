...
- **Quality gates pass** — `pnpm audit` clean; `type-check`, `lint`, `test:ci` green (240 tests, ~91% statements / ~83% branches).
...
3. **F035 + F037 — Surface swallowed errors** — Avatar upload catch and profile read failure should produce visible user-facing feedback.
...
| `pnpm lint`                | Pass                                                                                                                                                                                  |
| `pnpm test:ci`             | 240 tests pass; ~90.83% statements / 82.75% branches (thresholds met)                                                                                                                 |
