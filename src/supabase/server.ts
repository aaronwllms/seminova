 ...
 * exp-tolerated, never refresh. Session refresh: proxy on matched server
 * requests, browser client in Client Components; route gating stays proxy-owned.
 ...
 * Components — RSC reads must not write cookies.
 */
