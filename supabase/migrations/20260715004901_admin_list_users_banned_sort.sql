...
--
-- Migration: admin_list_users banned_until sort
-- Purpose: extend admin_list_users ORDER BY allowlist with banned_until asc/desc
...
begin
  ...
  order by
    ...
    case
      ...
      then case when u.banned_until <= now() then null else u.banned_until end
    end asc nulls last,
    case
