...
| 9     | SEO & GEO                                                                            | `Active`  | [docs/prds/phase-9-seo-geo.prd.md](docs/prds/phase-9-seo-geo.prd.md) |
...
**Active phase:** Phase 9 (SEO & GEO).

---

## Upcoming phases

### Phase 9 — SEO & GEO `Active`

Scoped — see [docs/prds/phase-9-seo-geo.prd.md](docs/prds/phase-9-seo-geo.prd.md). Ships the reusable technical-SEO foundation (metadata source-of-truth, robots + sitemap, structured-data and per-page OG patterns, and a codified SEO rule); GEO collapses into that foundation rather than a separate track. No hard sequencing dependency beyond Phase 4 being shipped.
...
Also folds in the **PM/agent workflow explainer page** (moved here from open questions): a click-through page off the landing surface explaining Seminova's two differentiators — the agent-ready conventions (`AGENTS.md` + `.cursor/rules/` + `.cursor/skills/`) and the PM/agent collaboration model (the Claude Desktop planning setup, MCP, and paired skills) — since a one-line landing card each doesn't convey how either works. Whether it co-ships with the pattern reference or broadens this phase's name/scope is settled at Phase 10 planning.
...
### Deterministic a11y enforcement (h1 / alt / heading order)
