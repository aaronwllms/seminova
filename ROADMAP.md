...
| 8     | Tech Debt Audit Remediation                                                          | `Ready`   | [docs/prds/phase-8-tech-debt-remediation.prd.md](docs/prds/phase-8-tech-debt-remediation.prd.md) |
| 9     | SEO & GEO                                                                            | `Draft`   | —   |
...
**No active phase.** Phase 8 (Tech Debt Audit Remediation) is `Ready` — its PRD is locked; flip to `Active` when the build starts.

---

## Upcoming phases

### Phase 8 — Tech Debt Audit Remediation `Ready`
