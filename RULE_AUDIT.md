...
1. **UI rules (`ui-styling`, `ui-accessibility`, `ui-shadcn`) carry redundant code examples** — several multi-block tutorials where file references and one principle would suffice (RA-009–RA-011; deferred).
