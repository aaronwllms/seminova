...
| ----- | ------------- | ---------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| TS023 | Coverage gaps | `src/hooks/use-password-accordion-scroll.ts:9-27`                                              | Low      | Native accordion scroll helper ~55%, untested.                                                                             | UX motion helper, not a trust boundary; TypeScript + visual review suffice for the deferred `scrollIntoView` call. | a11y/scroll bugs ship on password accordion           |
